...
export type TailorEvent =
  | { type: "stage-start"; id: string; no: number; label: string; index: number; total: number; workId?: string }
  ...
  | { type: "done"; title: string; body: string[]; chars: number; tickets: number; ticketsLeft?: number }
